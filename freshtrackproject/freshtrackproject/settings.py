"""
Django settings for freshtrackproject project.
...
SECRET_KEY = 'django-insecure-og96r(2c0bmg16r^=yd+)0hsj_8j7^_4%)5j-c5d237k=6mv0*'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['davideg.pythonanywhere.com', '127.0.0.1']
...
ROOT_URLCONF = 'freshtrackproject.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'freshtrack.context_processors.notifications_count',
            ],
        },
    },
]

WSGI_APPLICATION = 'freshtrackproject.wsgi.application'
